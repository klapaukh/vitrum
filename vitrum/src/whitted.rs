...
pub fn trace<T:Plane<Face<f32>, f32>>(ray: &Ray<f32>, model: &T, lights: &Vec<Vector3D<f32>>,
...
fn trace_down<T:Plane<Face<f32>, f32>>(ray: &Ray<f32>, model: &T, lights: &Vec<Vector3D<f32>>,
